...
export default function LoginUpdateProfile(props: LoginUpdateProfileProps) {
    ...
    return (
        ...
        >
            <form id="kc-update-profile-form" className={kcClsx("kcFormClass")} action={url.loginAction} method="post" onSubmit={handleSubmit}>
                ...
                <div className={kcClsx("kcFormGroupClass")}>
                    ...
                    <div id="kc-form-buttons" className={kcClsx("kcFormButtonsClass")}>
                        ...
                        {isAppInitiatedAction && (
                            <button
                                className={
                                    "bg-[#dbdbdf] w-full h-11 top-11 rounded-md text-[#29256E] font-medium text-base flex items-center justify-center gap-2"
                                }
                                type="submit"
                                name="cancel-aia"
                                value="true"
